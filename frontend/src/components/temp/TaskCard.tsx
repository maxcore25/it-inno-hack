...
function TaskCard({ task, deleteTask, updateTask }: Props) {
  ...
  return (
    <div
      ...
      className='task relative flex h-[100px] min-h-[100px] cursor-grab items-center rounded-xl bg-background p-2.5 text-left hover:ring-2 hover:ring-inset hover:ring-rose-500'
      onMouseEnter={() => {
        setMouseIsOver(true);
      }}
      onMouseLeave={() => {
